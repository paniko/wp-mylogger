...
This plugin use log4php libary for create custom loggers on your file system. Is possible specify the type (rolling, daily), name logger ect.
...
`<?php
	...
	$mylogger = My_Logger::get_instance("<your name logger>", My_Logger::ROLLING, $parameters);
